...
import com.edwin.osworks.api.model.OrdemServicoInput;
import com.edwin.osworks.api.model.OrdemServicoModel;
...
public class OrdemServicoController {
	...
	public ResponseEntity<OrdemServicoModel> buscar(@PathVariable Long ordemServicoId){
		...
		if(ordemServico.isPresent()) {
			...
			BeanUtils.copyProperties(ordemServico.get(), ordemServicoModel);*/
